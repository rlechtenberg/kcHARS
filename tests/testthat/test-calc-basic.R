...
test_that("calc_gender() calculations work", {
  ...
  expect_snapshot_value(output, style = "json2", ignore_attr = TRUE)
  ...
  expect_snapshot_value(output3, style = "json2", ignore_attr = TRUE)
})
...
test_that("calc_KingCo_region() calculations work", {
  ...
  #   )
  # ) |>
  #   saveRDS(testthat::test_path("testdata", "calc_KingCo_region_testdata.rds"))

  output <- readRDS(testthat::test_path(
    "testdata",
    "calc_KingCo_region_testdata.rds"
  )) |>
    calc_KingCo_region(
  ...
  expect_snapshot_value(x, style = "json2", ignore_attr = TRUE)
